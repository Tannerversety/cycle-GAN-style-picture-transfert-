...
parser.add_argument('--dataset_dir', dest='dataset_dir', default='sunset', help='path of the dataset')
parser.add_argument('--epoch', dest='epoch', type=int, default=180, help='# of epoch')
...
parser.add_argument('--save_freq', dest='save_freq', type=int, default=250, help='save a model every save_freq iterations')
